...
/** @pdOid 08f5714a-9359-44b8-99cb-0f8fd7d80122 */
public class RACUN {
   /** @pdOid e3236e07-fc47-4632-b545-58ef815196e1 */
   public java.lang.String BROJ_RACUNA;
   /** @pdOid 8c03cddc-1574-423d-b95a-e14e694a5cc8 */
   public double ID_RACUNA;
   
   /** @pdRoleInfo migr=no name=GASENJE_RACUNA assc=RELATIONSHIP_4 mult=0..1 */
   public GASENJE_RACUNA gASENJE_RACUNA;
   /** @pdRoleInfo migr=no name=DNEVNO_STANJE_RACUNA assc=RELATIONSHIP_5 coll=java.util.Collection impl=java.util.HashSet mult=0..* */
   public java.util.Collection<DNEVNO_STANJE_RACUNA> dNEVNO_STANJE_RACUNA;
   /** @pdRoleInfo migr=no name=KLIJENT assc=RELATIONSHIP_1 mult=1..1 side=A */
   public KLIJENT kLIJENT;
   /** @pdRoleInfo migr=no name=BANKA assc=RELATIONSHIP_2 mult=1..1 side=A */
   public BANKA bANKA;
